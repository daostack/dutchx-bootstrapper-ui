...
import { Address, Auction4ReputationBidEventResult, Auction4ReputationWrapper, StandardTokenWrapper, WrapperService } from '../services/ArcService';
...
export class Auction4Reputation extends DaoSchemeDashboard {
  ...
  public token: StandardTokenWrapper;
  public auctionId: number = -1;
