...
export class AureliaHelperService {
   ...
   * @param func
   */
  public createArrayWatch<T>(array: T[], func: (splices: Array<CollectionChangeSplice<T>>) => void): IDisposable {
   ...
   * @param propertyName
   */
  public createObservableComputedProperty<T>(object: any, propertyName: string, func: () => T, dependencies?: string[]): void {
